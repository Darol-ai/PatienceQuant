  ...
  const mutation = useMutation({
    mutationFn: async () => {
      ...
      const backtest = (await api.post('/backtests', {
        ...
        commission: .001,
        slippage: .0005,
        model_enabled: selected.model_enabled ?? true,
        model_buy_threshold: selected.model_buy_threshold ?? .60,
        model_down_threshold: selected.model_down_threshold ?? .25,
