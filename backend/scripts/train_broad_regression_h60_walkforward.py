"""horizon=60的回归逐年滚动训练，产出到 data/broad_regression_h60_model_walkforward/。

用法：
    conda activate stock
    cd PatienceQuant/backend
    python scripts/train_broad_regression_h60_walkforward.py
"""
...
DATA_PATH = Path(__file__).resolve().parent.parent / "data" / "broad_regression_h60_training_samples.parquet"
OUT_ROOT = Path(__file__).resolve().parent.parent / "data" / "broad_regression_h60_model_walkforward"
